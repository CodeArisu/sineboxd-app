                    ...
                    <ul role="list" class="divide-y divide-gray-200 dark:divide-[#3D3C3C]">
                        <li class="py-3 sm:py-4">
                            <div class="flex items-center">
                                <div class="shrink-0">
                                    <img class="w-8 h-8 rounded-full" src="{{ asset('assets/netflix.png') }}" alt="Netflix logo">
                                </div>
                        ...
                        <li class="py-3 sm:py-4">
                            <div class="flex items-center">
                                <div class="shrink-0">
                                    <img class="w-8 h-8 rounded-full" src="{{ asset('assets/youtube.png') }}" alt="YouTube logo">
                                </div>
                                <div class="flex-1 min-w-0 ms-4">
                                    <p class="text-sm font-medium text-gray-900 truncate dark:text-white">
                                        YouTube
