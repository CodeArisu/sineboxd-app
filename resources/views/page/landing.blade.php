...
<div class="relative left-1/2 -translate-x-1/2 w-[98.7vw] h-[100vh] flex items-center justify-center -mt-20 -z-10" x-data="{            
  ...
  <div class="relative w-full h-full">
    <template x-for="(slide, index) in slides" x-bind:key="index">
      <div x-cloak x-show="currentSlideIndex == index + 1" class="absolute inset-0" x-transition.opacity.duration.1000ms>
        ...
        <div class="absolute bottom-0 left-0 w-full h-[140vh] bg-gradient-to-t from-[#222222] via-[#222222]/20 to-transparent pointer-events-none"></div>
        <div class="absolute left-0 top-0 h-full w-[25vw] bg-gradient-to-r from-[#222222] via-[#222222]/20 to-transparent pointer-events-none"></div>
        <div class="absolute right-0 top-0 h-full w-[25vw] bg-gradient-to-l from-[#222222] via-[#222222]/20 to-transparent pointer-events-none"></div>
